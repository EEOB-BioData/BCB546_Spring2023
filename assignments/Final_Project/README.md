...
Groups of 2 to 5 students will identify a paper that utilizes computational skills in any area of biology but lacks sufficient documentation to easily replicate the analysis pipeline. Collectively, each group will identify analyses from this manuscript to reproduce and document using the computational skills and documentation standards you have learned in class.
...
**Repository Name**: Please include "BCB546_Spring2023" in the name of your repository.
...
The deadline for forming groups is **April 5th, 2023**. When you have formed your group, _post your group name and list of members_ on the Slack `#final-project` channel. 
...
**The deadline for submitting your repository on Canvas is May 5th, 2023.**
